...
- Semantic HTML5 structure using tags like `<header>`, `<section>`, `<footer>`, and `<hr>`.
...
![Webpage Screenshot 1](assets/webpage_lookup_01.png)
![Webpage Screenshot 2](assets/webpage_lookup_02.png)
